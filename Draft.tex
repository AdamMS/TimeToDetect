...
Stan model code and \texttt{rstan} code to run the models can be found in supplemental materials (Section \ref{S-s:models}).  
...
Because of the difficulty in integrating random effects over all sites, approximate posterior distributions for the study-wide marginal $\pdet$ were obtained by simulating data from each MCMC iteration and calculating the proportion simulated Ovenbirds that were observed.
...
\adam{Create Supplemental Figure!}
