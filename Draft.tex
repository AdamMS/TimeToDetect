...
\caption{\label{HazardFxns}  Examples of instantaneous rates of detection (hazard functions) from exponential, gamma, lognormal, and Weibull TTDDs. \jarad{Are these setup to have the same mean and variance or anything like that?}
\end{figure}
