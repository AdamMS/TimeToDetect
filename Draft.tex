...
We employ a log link for $\varphi$.
This makes our model equivalent to a generalized linear model with a log link on the mean detection time.
...
Observer effects on singing rates can be mitigated by introducing a settling down period but at the potential cost of a serious reduction in total observations \citep{LeeMarsden2008}.
