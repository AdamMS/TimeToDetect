...
\graphicspath{{"Oral Prelim/"}{Sims/SimZero/}{OVEN/oven_sum/}}
...
\includegraphics[width=\textwidth]{AMRO_JABES} % Source file: Oral Prelim/TTDD_Demo.R
...
\begin{figure}\centering
\includegraphics[width=\textwidth]{mixture_fig} % Source file: Sims/SimZero/Outputs_Code_zero.R
\caption{
...
\begin{figure}\centering
\includegraphics[width=\textwidth]{Posteriors_Families_draft} % Source file: Sims/SimZero/RepresentativePosteriors.R
...
\begin{figure}\centering
\includegraphics[width=\textwidth]{family_fig} % Source file: Sims/SimZero/Outputs_Code_zero.R
\caption{
...
\includegraphics[width=0.95\textwidth]{OVEN_Posteriors} % Source file: OVEN/Compile.R
