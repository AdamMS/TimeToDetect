...
Because our main goal with these studies was to demonstrate poor performance under model misspecification, and because the computation time for sampling from some models was large, we simulated only a small number of replicates.
