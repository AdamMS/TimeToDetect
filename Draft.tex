...
\jarad{need to define what we mean by $\pdet$ here since it's definition has changed.}

\jarad{I think we should just refer to to the Figures on the supplement just like we refer to papers in the main manuscript and then interpret them, e.g. Figure S1 shows ...}
