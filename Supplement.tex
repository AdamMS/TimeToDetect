...
% Plug-in caption for figures created using \sfig
...
% Include graphics for posterior estimates of dataset parameters
\newcommand{\sfig}[2]{\begin{figure}
  \includegraphics[width=1.0\textwidth]{Sims/SimFull/Posteriors_all_simdat#2.jpg} % Source file: Sims/SimFull/Outputs_Code_sf.R
  \caption{\capt{#1}}
  \end{figure}
}
...
\includegraphics[width=0.98\textwidth]{Sims/SimFull/pdet_cater_family} % Source file: Sims/SimFull/Outputs_Code_sf.R
