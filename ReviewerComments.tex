...
\begin{quote}
\adam{Address this point in the abstract}
\end{quote}
...
Meanwhile, as disscussed later, a simulation study involving effects on abundance and detection is computationally expensive.
...
\begin{quote}
Average run times for the different simulation studies are now discussed in the second paragraph of Section \ref{M-sec:simfull}.
\end{quote}
...
\begin{quote}
\adam{
To avoid potentially a lot of rewriting, I think we should add an abbreviated version of Equation (1) at the end of Section 3.2.
I am struggling with this at present.
}
\end{quote}
